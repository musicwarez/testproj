...
def on_clicked():
    print (u"КНопка нажата. - Функция on_clicked () ")
...
class MyClass():
    ...
    def __call__(self, *args, **kwargs):
        print(u"КНопка нажата. - Метод MyClass.__call__()")
        print("x =", self.x)

    def on_clicked(self):
        print(u"КНопка нажата. - Метод MyClass().on_clicked()")

obj = MyClass()
app = QtGui.QApplication(sys.argv)
button = QtGui.QPushButton(u"Haжми меня")
